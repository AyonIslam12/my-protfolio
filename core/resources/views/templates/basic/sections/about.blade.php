@php
   ...
   $elements =  getContent('about.element',false,'',1);
@endphp
      ...
      <div class="row justify-content-between align-items-center">
        <div class="col-xl-6 order-xl-1 order-2 mt-xl-0 mt-5">
          ...
          <ul class="award-list d-flex flex-wrap align-items-center mt-3">
              ...
              <li><img src="{{getImage('assets/images/frontend/about/'.@$el->data_values->award_logo,'100x100')}}" alt="image"></li>
              @endforeach
          </ul>
          <a href="{{url(@$content->button_link)}}" class="btn btn--base btn--custom mt-5">{{__(@$content->button_name)}}</a>
        </div>
        <div class="col-xl-5 order-xl-2 order-1">
          <div class="about-thumb">
            <img src="{{getImage('assets/images/frontend/about/'.@$content->background_image,'992x692')}}" alt="image" class="wow fadeInUp" data-wow-duration="0.3" data-wow-delay="0.3s">
