                ...
                @foreach ($expertice_element ?? [] as  $item)
                    <div class="col-lg-6 col-md-6 pb-3">
                        ...
                        <div class="service-box-item-content">
                            ...
                            <a href="javascript:void(0)" class="detailsBtn" data-title ="{{ @$item->data_values->title }}" data-img="{{getImage('assets/images/frontend/expertise/'.@$item->data_values->details_img)}}" data-details ="{{ strip_tags(@$item->data_values->details) }}">{{ __("Read More") }}</a>
                        </div>
                        </div>
                    </div>
                @endforeach
    ...
    <div class="modal-dialog">
       <div class="modal-content">
          ...
          <div class="modal-body service-model-content">
             <figure class="mb-0">
                <img src="" alt="ui-ux-model-img " class="img-fluid _image">
             </figure>
             <h4 class="_title">--</h4>
 ...
 <script>
     (function ($) {
        ...
        $('.detailsBtn').on('click', function() {
            ...
            $('._details').text(details); // Get the text
            modal.modal('show');
        });
    })(jQuery);
    </script>
